...
from ThakurMusic.utils import AdminRightsCheck
from ThakurMusic.utils.database import is_active_chat, is_nonadmin_chat
from ThakurMusic.utils.decorators.language import languageCB
from ThakurMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await ThakurMusic.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
