...
from ThakurMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ThakurMusic.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("shiv_ThakurMusic") & ~BANNED_USERS)
@languageCB
